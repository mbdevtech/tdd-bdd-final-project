...
class TestProductModel(unittest.TestCase):
    ...
    def test_update_a_product(self):
        ...
        logger.info("Product is created with properties %s, %s, %s ...", product.name, product.description, product.price)
        # Assert that the ID of the product object is not None after calling the create() method.
        self.assertIsNotNone(product.id)
        ...
        product.update()
        # Assert that the id is same as the original id but description property has been updated correctly.
